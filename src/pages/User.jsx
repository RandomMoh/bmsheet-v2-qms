        ...
        <main className="content" style={['current', 'issue', 'done'].includes(section) ? { overflow: 'hidden' } : { overflowY: 'auto' }}>
          ...
          {['current', 'issue', 'done'].includes(section) && (
            <div className="toolbar fade-up" style={{ position: 'relative', zIndex: 20 }}>
              {section === 'current' && <>
                <div><label className="lbl">From</label><input type="date" value={fromDate} onChange={e => { setFromDate(e.target.value); setPage(1) }} className="inp date-picker-inp" /></div>
                <div><label className="lbl">To</label><input type="date" value={toDate} onChange={e => { setToDate(e.target.value); setPage(1) }} className="inp date-picker-inp" /></div>
              </>}
          ...
          {section === 'reports' && (
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              <div className="toolbar fade-up">
                <div><label className="lbl">From</label><input type="date" value={reportFrom} onChange={e => setReportFrom(e.target.value)} className="inp date-picker-inp" /></div>
                <div><label className="lbl">To</label><input type="date" value={reportTo} onChange={e => setReportTo(e.target.value)} className="inp date-picker-inp" /></div>
